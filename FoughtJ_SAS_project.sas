...
DATE: Monday, January 12, 2015     TIME: 4:30:40 PM
PROJECT: FoughtJ_SAS_project_Jan 12 2015
PROJECT PATH: P:\QAC\qac200\students\jfought\Assignments\FoughtJ_SAS_project_Jan 12 2015.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\jfought\Assignments\FoughtJ_SAS_project_Jan 12 2015.egp';
%LET _CLIENTPROJECTNAME='FoughtJ_SAS_project_Jan 12 2015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:10 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:12 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:28 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:29 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:30 PM
...
PROC SQL;
   ...
   SELECT /* Aggregate_SF12_Catagorical */
            (CASE  
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:46 PM
...
GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.QUERY_FOR_MOVEMENT_RESCORED);

PROC SQL;
   CREATE TABLE WORK.QUERY_FOR_MOVEMENT_RESCORED AS 
...
/*   START OF NODE:  SUM For Aggregate Movment Difficulty Variable   */
%LET _CLIENTTASKLABEL=' SUM For Aggregate Movment Difficulty Variable';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\jfought\Assignments\FoughtJ_SAS_project_Jan 12 2015.egp';
%LET _CLIENTPROJECTNAME='FoughtJ_SAS_project_Jan 12 2015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:28:47 PM
   By task:  SUM For Aggregate Movment Difficulty Variable
...
GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MYDATA.Movement_Difficulty_Catagorical);

PROC SQL;
   CREATE TABLE MYDATA.Movement_Difficulty_Catagorical(label="Movement_Difficulty_Catagorical") AS 
   SELECT /* Movement_Difficulty_Catagorical */
            (CASE  
               WHEN t1.Aggregate_Movement_Variable >=2 and t1.Aggregate_Movement_Variable < 9
               THEN 1
               WHEN t1.Aggregate_Movement_Variable >=9 and t1.Aggregate_Movement_Variable < 12
               THEN 2
               WHEN t1.Aggregate_Movement_Variable >=12 and t1.Aggregate_Movement_Variable < 14
               THEN 3
               ELSE 4
            END) LABEL="Catagorical value of Aggregate Movement Difficulty" AS Movement_Difficulty_Catagorical, 
          t1.Aggregate_Movement_Variable
      FROM WORK.QUERY_FOR_MOVEMENT_RESCORED t1;
QUIT;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:29:02 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:29:18 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Monday, January 12, 2015 at 4:29:33 PM
